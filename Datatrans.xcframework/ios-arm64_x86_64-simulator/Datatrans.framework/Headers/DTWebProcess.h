...
- (void)webProcessDidFail:(nonnull id<DTWebProcess>)webProcess error:(nonnull NSError *)error transactionId:(nullable NSString *)transactionId params:(nonnull NSDictionary<NSString*, NSString*> *)params;
